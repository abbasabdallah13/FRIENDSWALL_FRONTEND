...
const CountrySelect = ({setUserInfo, userInfo, style}) => {
    return (
        <FormControl fullWidth>
        <InputLabel id="demo-simple-select-label">Country</InputLabel>
        <Select style={style} label='Country' value={userInfo?.country} id="country" name="country" onChange={(e)=>setUserInfo({...userInfo, country:e.target.value})} >
